      ...
      */
      ...
      datasources: {
        influxdb: {
          default: true,
          type: 'influxdb',
          url: "http://ec2-52-0-199-129.compute-1.amazonaws.com:8086/db/test-db",
          username: 'root',
          password: 'root',
        },
        kairosdb: {
          type: 'KairosDBDatasource',
          url: 'http://ec2-52-0-199-129.compute-1.amazonaws.com:8080',
        },
        ui: {
          grafanaDB: true,
          type: 'influxdb',
          url: "http://ec2-52-0-199-129.compute-1.amazonaws.com:8086/db/grafana",
          username: 'grafana',
          password: 'grafana',
        }
      },
